...
const financeLinks = [
  ...
  { path: '/school-finance/exceptions', label: 'Exceptions', description: 'Reconciliation, receipt and ledger exceptions', icon: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z', color: 'from-red-500 to-red-600' },
  { path: '/school-finance/outstanding', label: 'Outstanding Balances', description: 'Student fee balances and collection tracking', icon: 'M12 1l3.904 7.944L24 9.75l-6 5.849 1.416 8.256L12 20.5l-7.416 3.896L6 15.599 0 9.75l8.096-1.806L12 1z', color: 'from-rose-500 to-rose-600' },
